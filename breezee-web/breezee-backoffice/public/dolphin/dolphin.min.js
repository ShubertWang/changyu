...
;/*!/js/core.js*/
!function($){var DOLPHIN={},thisTool=DOLPHIN;DOLPHIN.defaults={ajax:{param:{type:"get",dataType:"json",data:{},contentType:"application/json; charset=UTF-8",async:!0,cache:!1,loading:!1,mockPathData:null},requestHeader:{},formatterRequestData:null,originalPath:"/data",mockPath:"/mockData",returnMsgKey:"returnMsg"},compare:function(t,e){return t==e},array:{separator:",",formatter:null},date:{dateFormat:"yyyy-MM-dd",dateTimeFormat:"yyyy-MM-dd hh:mm:ss"},modalWin:{title:"系统提示",content:null,footer:null,defaultHidden:!1,init:null,hide:null,hidden:null},alert:{width:"300px",title:"系统提示",countDownFlag:!0,countDownTime:3},confirm:{width:"300px",title:"系统提示"},prompt:{width:"300px",title:"系统提示",mustFlag:!1,type:"text",placeholder:"",defaultValue:"",items:null,idField:"code",textField:"name"},img:{mockPath:"/public/mockImg",param:{prefixPath:"/public/mockImg",suffixPath:".png",style:{}}},url:{viewPrefix:""},mockFlag:!1},DOLPHIN.template={},DOLPHIN.browser=function(){var t={appName:"unknown",version:0,isMobile:!1,msIe:!1,firefox:!1,opera:!1,safari:!1,chrome:!1,netscape:!1},e=window.navigator.userAgent;return/(msie|firefox|opera|chrome|netscape)\D+(\d[\d.]*)/.test(e.toLowerCase())?(t[RegExp.$1]=!0,t.appname=RegExp.$1,t.version=RegExp.$2):/version\D+(\d[\d.]*).*safari/.test(e.toLowerCase())&&(t.safari=!0,t.appname="safari",t.version=RegExp.$2),t.ismobile=/mobile|Mobile/.test(e),t.language=navigator.language,t}(),DOLPHIN.path=function(){var t,e={};for(t in location)"function"!=typeof location[t]&&(e[t]=location[t]);var o=e.pathname.split("/");return e.contextPath="/"+o[1],e}(),DOLPHIN.requestMethod={GET:"get",POST:"post",PUT:"put",DELETE:"delete"},DOLPHIN.emptyObj=function(t){for(var e in t)delete t[e];return t},DOLPHIN.isPrime=function(t){for(var e="";--t>=0;)e+="1";return!/^1?$|^(11+?)\1+$/.test(e)},DOLPHIN.isInt=function(t){return t==parseInt(t)},DOLPHIN.isNumber=function(t){return t==parseFloat(t)},DOLPHIN.isPositiveNumber=function(t,e){return t>0||!e&&0==t},DOLPHIN.compareDate=function(t,e){return t.getTime()-e.getTime()},DOLPHIN.urlAddParam=function(t,e){var o,n=t;switch(this.typeof(e)){case"array":for(var a=0;a<e.length;a++)n=this.urlAddParam(n,e[a]);break;case"object":for(o in e)n+=n.indexOf("?")>0?"&":"?",n+=o+"="+e[o]}return n},DOLPHIN.typeof=function(t){var e;switch(typeof t){case"object":e=$.isArray(t)?"array":null===t?"null":"object";break;default:e=typeof t}return e},DOLPHIN.objInArray=function(t,e,o){for(var n=o||this.defaults.compare,a=0;a<e.length;a++)if(n(t,e[a]))return!0;return!1},DOLPHIN.objIndexOfArray=function(t,e,o){for(var n=o||this.defaults.compare,a=0;a<e.length;a++)if(n(t,e[a]))return a;return-1},DOLPHIN.randomInt=function(t,e){return e=e||0,e+Math.round(Math.random()*(t-e))},DOLPHIN.random=function(t){var e=t||6,o=Math.round(Math.random()*Math.pow(10,e)),n=o+"";if(n.length<e)for(var a=0;a<e-n.length;)n="0"+n;return n},DOLPHIN.dateDifference=function(t,e){var o,n,a,r=[],i=["毫秒","秒","分钟","小时","天"],l=[1e3,60,60,24],s=0;try{if(o=Math.abs(t.getTime()-e.getTime()),0==o)n=0;else{for(n="";o>0&&s<l.length;)r.push(o%l[s]),o=Math.floor(o/l[s]),s++;for(o>0&&r.push(o),a=0;a<r.length;a++)n=r[a]+i[a]+n}}catch(u){return console.log(u),n}return n},DOLPHIN.splitString=function(t,e){var o=$.extend({},this.defaults.array,e),n=t.split(o.separator);if("function"==typeof o.formatter)for(var a=0;a<n.length;a++)n[a]=o.formatter(n[a],n);return n},DOLPHIN.joinArray=function(t,e){var o=$.extend({},this.defaults.array,e),n="";if("function"==typeof o.formatter)for(var a=0;a<t.length;a++)0!=a&&(n+=o.separator),n+=o.formatter(t[a]);else n=t.join(o.separator);return n},DOLPHIN.string2json=function(t){var e=null;try{e=jQuery.parseJSON(t)}catch(o){console.warn(o),e=t}return e},DOLPHIN.json2string=function(t,e){try{return"single"==e?JSON.stringify(t).replace(/\"/g,"\\'"):"double"==e?JSON.stringify(t).replace(/\"/g,'\\"'):JSON.stringify(t)}catch(o){return console.warn(o),t}},DOLPHIN.string2date=function(string,format){format=format||thisTool.defaults.date.dateFormat;var y=string.substring(format.indexOf("y"),format.lastIndexOf("y")+1),M=string.substring(format.indexOf("M"),format.lastIndexOf("M")+1),d=string.substring(format.indexOf("d"),format.lastIndexOf("d")+1),h=string.substring(format.indexOf("h"),format.lastIndexOf("h")+1),m=string.substring(format.indexOf("m"),format.lastIndexOf("m")+1),s=string.substring(format.indexOf("s"),format.lastIndexOf("s")+1);(null==s||""==s||isNaN(s))&&(s=(new Date).getSeconds()),(null==m||""==m||isNaN(m))&&(m=(new Date).getMinutes()),(null==h||""==h||isNaN(h))&&(h=(new Date).getHours()),(null==d||""==d||isNaN(d))&&(d=(new Date).getDate()),(null==M||""==M||isNaN(M))&&(M=(new Date).getMonth()+1),(null==y||""==y||isNaN(y))&&(y=(new Date).getFullYear());var dt=null;return eval("dt = new Date('"+y+"', '"+(M-1)+"','"+d+"','"+h+"','"+m+"','"+s+"')"),dt},DOLPHIN.date2string=function(t,e){e=e||thisTool.defaults.date.dateFormat;var o={"M+":t.getMonth()+1,"d+":t.getDate(),"h+":t.getHours(),"m+":t.getMinutes(),"s+":t.getSeconds(),"w+":"天一二三四五六".charAt(t.getDay()),"q+":Math.floor((t.getMonth()+3)/3),S:t.getMilliseconds()};/(y+)/.test(e)&&(e=e.replace(RegExp.$1,(t.getFullYear()+"").substr(4-RegExp.$1.length)));for(var n in o)new RegExp("("+n+")").test(e)&&(e=e.replace(RegExp.$1,1==RegExp.$1.length?o[n]:("00"+o[n]).substr((""+o[n]).length)));return e},DOLPHIN.longDate2string=function(t,e){if(t){var o=new Date(t);return this.date2string(o,e)}return""},DOLPHIN.jsonDate2string=function(t,e){var o=null,n=null,a=null;return"string"==typeof t?(n=t,o=this.string2json(t)):(n=this.json2string(t),o=t),o&&o.time?(a=new Date(o.time),this.date2string(a,e)):this.i18n.get("core_jsonDate2string_error",n)},DOLPHIN.require=function(t){var e=Dolphin.path.contextPath+"/public"+Dolphin.systemConfig.pageScript+(Dolphin.browser.ismobile?"/mobile":"/desktop")+t+".js";document.write('<script src="'+e+'"></script>')},DOLPHIN.ajax=function(t){var e,o,n=null,a={success:function(e,o){n=e,e.success?"function"==typeof t.onSuccess&&t.onSuccess(e,o):thisTool.alert(e[thisTool.defaults.ajax.returnMsgKey]||thisTool.i18n.get("core_ajax_error"),{countDownFlag:!1,callback:function(){"function"==typeof t.onError&&t.onError(e)}})},error:function(e,o){"parsererror"==o&&200==e.status?n=e.responseText:500==e.status?thisTool.alert(o+"<br/>"+e.status+"<br/>"+e.responseText,{countDownFlag:!1}):403==e.status?thisTool.alert(thisTool.i18n.get("core_login_timeout")+'<br/><a href=".">'+thisTool.i18n.get("core_reLogin")+"</a>",{countDownFlag:!1}):404==e.status?(thisTool.alert(o+"<br/>"+e.status+"<br/>"+this.url,{countDownFlag:!1}),n=o,"function"==typeof t.onError&&t.onError(o)):(thisTool.alert(o+"<br/>"+e.status,{countDownFlag:!1}),n=o,"function"==typeof t.onError&&t.onError(o))},beforeSend:function(e){"function"==typeof t.onBeforeSend&&t.onBeforeSend.call(thisTOOL,reData),t.loading&&$("body > #loading").show();var o=$.extend({},thisTool.defaults.ajax.requestHeader,t.requestHeader);for(var n in o)e.setRequestHeader(n,o[n])},complete:function(e,o){"function"==typeof t.onComplete&&t.onComplete(e,o),t.loading&&$("body > #loading").hide()}};if(e=$.extend({},thisTool.defaults.ajax.param,a,t),"function"==typeof thisTool.defaults.ajax.formatterRequestData&&(e.data=thisTool.defaults.ajax.formatterRequestData.call(thisTool,e.data,e)),"function"==typeof e.formatterRequestData&&(e.data=e.formatterRequestData.call(thisTool,e.data,e)),e.pathData)for(o in e.pathData)e.url=e.url.replace("{"+o+"}",e.pathData[o]);if(thisTool.defaults.mockFlag&&e.url.indexOf(thisTool.defaults.ajax.originalPath+"/")>=0){var r,i,l,s="",u=e.url.indexOf("?")>0?!0:!1;if(e.url=e.url.replace(thisTool.defaults.ajax.originalPath,thisTool.defaults.ajax.mockPath),e.mockPathData)if($.isArray(e.mockPathData)){for(r=e.url.split("/"),u&&(i=r[r.length-1].split("?"),r[r.length-1]=i[0]),l=1;l<=e.mockPathData.length;l++)r[r.length-l]=e.mockPathData[e.mockPathData.length-l];e.url=r.join("/"),u&&(e.url+="?"+i[1])}else if("object"==typeof e.mockPathData)for(o in e.mockPathData)e.url=e.url.replace("{"+o+"}",e.mockPathData[o]);s="_"+e.type,u?e.url=e.url.replace("?",s+".json?"):e.url+=s+".json",e.type="get"}if(!e.forceUrl){var c;c=new RegExp("/"==thisTool.path.contextPath?"^/":"^"+thisTool.path.contextPath+"/"),c.test(e.url)||/^http:\/\//.test(e.url)||(e.url=thisTool.path.contextPath+e.url)}return $.ajax(e),n},DOLPHIN.modalWin=function(t){var e,o,n,a,r,i,l=$.extend({},thisTool.defaults.modalWin,t);return e=$('<div class="modal fade">').appendTo("body"),o=$('<div class="modal-dialog">').css({width:l.width}).appendTo(e),n=$('<div class="modal-content">').appendTo(o),a=$('<div class="modal-header">').appendTo(n),$('<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>').appendTo(a),$('<h4 class="modal-title">').html(l.title).appendTo(a),r=$('<div class="modal-body">').appendTo(n),r.append(l.content),l.footer&&(i=$('<div class="modal-footer">').appendTo(n),i.append(l.footer)),"function"==typeof l.init&&l.init.call(e),"function"==typeof l.show&&e.on("show.bs.modal",function(){l.show.call(e)}),"function"==typeof l.shown&&e.on("shown.bs.modal",function(){l.shown.call(e)}),"function"==typeof l.hide&&e.on("hide.bs.modal",function(){l.hide.call(e)}),"function"==typeof l.hidden&&e.on("hidden.bs.modal",function(){l.hidden.call(e)}),e.modal(l.defaultHidden?"hide":"show"),e},DOLPHIN.alert=function(t,e){var o,n=this,a=$.extend({},thisTool.defaults.alert,e);return this.browser.isMobile?(alert(t),"function"==typeof a.callback&&a.callback.call(this),!1):(a.content=t,a.countDownFlag!==!1&&(a.footer=$("<div>"),o=$('<span class="countDown">').appendTo(a.footer),o.html(n.i18n.get("core_alert_countDown",a.countDownTime)),a.init=function(){function t(){var t=arguments.callee;0!=e?(o.html(n.i18n.get("core_alert_countDown",e)),e--,setTimeout(function(){t()},1e3)):r.modal("hide")}var e=a.countDownTime,r=this;t()}),"function"==typeof a.callback&&(a.hide=function(){try{a.callback.call(this)}catch(t){console.error(t)}}),a.hidden=function(){this.remove()},this.modalWin(a))},DOLPHIN.confirm=function(t,e){var o,n,a=$.extend({},thisTool.defaults.confirm,e),r=!1,i=a.callback;return a.content=t,a.footer=$("<div>"),o=$('<button type="button" class="btn btn-primary btn-small">'+thisTool.i18n.get("core_confirm_yes")+"</button>").appendTo(a.footer),n=$('<button type="button" class="btn btn-default btn-small" >'+thisTool.i18n.get("core_confirm_no")+"</button>").appendTo(a.footer),a.init=function(){var t=this;o.click(function(){r=!0,t.modal("hide")}),n.click(function(){t.modal("hide")})},"function"==typeof i&&(a.hide=function(){i.call(this,r)}),a.hidden=function(){this.remove()},this.modalWin(a)},DOLPHIN.prompt=function(t,e){function o(){switch(l.type){default:s=i.val()}}var n,a,r,i,l=$.extend({},thisTool.defaults.prompt,e),s=null,u=l.callback;switch(l.content=$("<div>"),$("<div>").append(t).appendTo(l.content),r=$("<div>").appendTo(l.content),l.type){default:i=$('<input type="text" class="form-control" placeholder="'+l.placeholder+'" value="'+l.defaultValue+'">')}return i.appendTo(r),l.footer=$("<div>"),n=$('<button type="button" class="btn btn-primary btn-small">'+thisTool.i18n.get("core_prompt_ok")+"</button>").appendTo(l.footer),a=$('<button type="button" class="btn btn-default btn-small" >'+thisTool.i18n.get("core_prompt_cancel")+"</button>").appendTo(l.footer),l.init=function(){var t=this;i.focus(),n.click(function(){o(),t.modal("hide")}),a.click(function(){t.modal("hide")})},"function"==typeof u&&(l.hide=function(){u.call(this,s)}),l.hidden=function(){this.remove()},this.modalWin(l)},DOLPHIN.toggleCheck=function(t,e){t.each(function(){this.checked="boolean"==typeof e?e:!this.checked,$(this).change()})},DOLPHIN.toggleEnable=function(t,e){var o;t.each(function(){o=null==e?!!$(this).attr("disabled"):e,o?$(this).removeAttr("disabled"):$(this).attr("disabled","disabled")})},DOLPHIN.goHistory=function(){history.go(-1)},DOLPHIN.goUrl=function(t){0!=t.indexOf("http://")&&(t=this.path.contextPath+this.defaults.url.viewPrefix+t),location.href=t},DOLPHIN.console=null,DOLPHIN.cookie=function(t,e,o){if("undefined"==typeof e){var n=null;if(document.cookie&&""!=document.cookie)for(var a=document.cookie.split(";"),r=0;r<a.length;r++){var i=jQuery.trim(a[r]);if(i.substring(0,t.length+1)==t+"="){n=decodeURIComponent(i.substring(t.length+1));break}}return n}o=o||{},null===e&&(e="",o.expires=-1);var l="";if(o.expires&&("number"==typeof o.expires||o.expires.toUTCString)){var s;"number"==typeof o.expires?(s=new Date,s.setTime(s.getTime()+24*o.expires*60*60*1e3)):s=o.expires,l="; expires="+s.toUTCString()}var u=o.path?"; path="+o.path:"",c=o.domain?"; domain="+o.domain:"",d=o.secure?"; secure":"";document.cookie=[t,"=",encodeURIComponent(e),l,u,c,d].join("")},DOLPHIN.createImg=function(t){var e,o=$("<img>"),n=$.extend({},this.defaults.img.param,t);return e=this.defaults.mockFlag?this.path.contextPath+this.defaults.img.mockPath+(n.url||(n.id?"/"+n.id:!1)||"/null")+n.suffixPath:this.path.contextPath+n.prefixPath+(n.url||(n.id?"/"+n.id:!1)||"/null.png"),o.attr("src",e),o.addClass(n.css),o.css(n.style),o},DOLPHIN.initLoadingPanel=function(t){var e,o,n,a;return e=$('<div class="loading" id="loading">').appendTo(t),o=$('<div class="progressPanel">').appendTo(e),n=$('<div class="progress">').appendTo(o),a=$('<div class="progress-bar progress-bar-striped active"></div>').css("width","100%").appendTo(n),e},window.Dolphin=DOLPHIN,window.TOOL=DOLPHIN,$.Dolphin=DOLPHIN}(jQuery);
;/*!/js/i18n.js*/
